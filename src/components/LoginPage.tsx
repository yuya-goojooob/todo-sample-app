  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-100 to-indigo-50 flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-10 max-w-sm w-full text-center">
        ...
        <h1 className="text-2xl font-bold text-slate-800 mb-2">TODO App</h1>
        <p className="text-sm text-slate-500 mb-8">
          タスクを管理するにはログインしてください
        </p>

        <button
          onClick={onLogin}
          className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-slate-900 text-white rounded-xl font-medium hover:bg-slate-700 transition-colors"
        >
